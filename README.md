...
- 路线教练：局内用 4 步中文引导解释首局路线，按状态提示先补流明、靠近信标、按住维修、撤离升级；画布导航会给当前目标加导引线、光环和“导航：流明/信标/维修/光门”短标签，遇到风暴、碎片贴脸或低电量时会切换成紧急提示。
...
- 局内任务条和导航提示：HUD 会把当前目标写成“当前任务/紧急任务/撤离任务”，提示下一步该补流明、修信标、脱离风暴或撤离，画布中会给目标加导引线、光环和短中文标签。
...
- `src/game/GameScene.ts`：Phaser 场景、程序化视觉、中文物件标签、路线教练导航导引、画布导航目标标签、开局路线预览、画布维修按键提示、合约目标标记、碎片轨迹预警、维修光束、危险警戒、可访问性渲染设置、输入桥接、合约完成反馈和反馈事件
