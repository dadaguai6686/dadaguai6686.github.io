...
- 路线教练：局内用 4 步中文引导解释首局路线，HUD 会用短进度轨标出“补流明 → 找信标 → 按住维修 → 撤离”的当前阶段；画布导航会给当前目标加导引线、光环和“导航：流明/信标/维修/光门”短标签，遇到风暴、碎片贴脸或低电量时会切换成紧急提示。
...
- `src/main.ts`：中文 HUD、局内任务条、任务档案、战术合约面板、战场图例、战术雷达、暂停战术扫描、下一局目标看板、路线教练进度轨、实时评级、资源告警、导航提示、当前改装、菜单成就墙、今日挑战最佳、最近航行日志、触控、暂停/设置工具、可访问性设置、成绩/成就存档、音效、结算评级、复盘和升级 UI
