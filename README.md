...
- 中文结算复盘：展示分数、波次、用时、最佳连锁、流明、信标、受击和风暴停留，并根据失败原因或胜利状态生成三步“下一局/下一波作战计划”，例如补给路线、半修撤离、脉冲保命、下一波预报和升级短板。
...
- `src/main.ts`：中文 HUD、局内任务条、首屏快速目标、任务档案、出航简报、战术合约面板、路线更新提示、战场图例、战术雷达、暂停战术扫描、下一局目标看板、路线教练进度轨、实时评级、资源告警、导航提示、当前改装、菜单成就墙、今日挑战最佳、最近航行日志、触控、暂停/设置工具、可访问性设置、成绩/成就存档、音效、结算评级、复盘和升级推荐 UI
