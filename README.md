...
- `src/game/simulation.ts`：可测试的游戏状态、难度、波次事件、终局、计分、升级摘要、目标提示、结算评级、复盘统计和暂停逻辑
- `src/game/GameScene.ts`：Phaser 场景、程序化视觉、导航导引、输入桥接、即时视觉反馈和反馈事件
- `src/main.ts`：中文 HUD、导航提示、当前改装、菜单、触控、暂停、成绩存档、音效、结算评级、复盘和升级 UI
