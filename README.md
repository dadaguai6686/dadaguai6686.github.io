...
开始按钮保持在详细说明之前，方便手机玩家马上开局；按钮之后的出航简报会用小地图和“安全读图、补给起手、按住维修、北侧撤离”四条中文作战令解释首局路线，让玩家不用猜颜色和目标。
...
- `src/main.ts`：中文 HUD、局内任务条、任务档案、出航简报、战术合约面板、路线更新提示、战场图例、战术雷达、暂停战术扫描、下一局目标看板、路线教练进度轨、实时评级、资源告警、导航提示、当前改装、菜单成就墙、今日挑战最佳、最近航行日志、触控、暂停/设置工具、可访问性设置、成绩/成就存档、音效、结算评级、复盘和升级 UI
