...
- `src/game/GameScene.ts`：Phaser 场景、程序化视觉、中文物件标签、路线教练导航导引、维修光束、危险警戒、输入桥接、合约完成反馈和反馈事件
- `src/main.ts`：中文 HUD、战术合约面板、战场图例、下一局目标看板、路线教练、实时评级、资源告警、导航提示、当前改装、菜单成就墙、今日挑战最佳、最近航行日志、触控、暂停/设置工具、成绩/成就存档、音效、结算评级、复盘和升级 UI
