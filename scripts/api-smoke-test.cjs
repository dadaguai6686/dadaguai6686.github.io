...
async function run() {
  ...
  try {
    ...
    assert(serviceWorkerText.includes('atherix-static-v83-quality'), 'service worker should use the latest quality cache version');
    ...
    assert(serviceWorkerText.includes('/style.css?v=20260608-quality-v14') && serviceWorkerText.includes('/app.js?v=20260608-quality-v40'), 'service worker should precache the latest versioned app assets');
    ...
    assert(indexText.includes('href="/style.css?v=20260608-quality-v14"') && indexText.includes('src="/app.js?v=20260608-quality-v40"'), 'index should reference the latest versioned app assets');
    assert(indexText.includes('rel="preload" href="/style.css?v=20260608-quality-v14" as="style"') && indexText.includes('rel="preload" href="/app.js?v=20260608-quality-v40" as="script"') && indexText.includes('rel="preload" href="/lucide.min.js" as="script"'), 'index should preload critical local app assets');
    ...
    assert(indexText.includes('<strong>34</strong>成就'), 'index shell should expose the current arcade achievement count');
    ...
    const appScript = await fetch(`${baseUrl}/app.js?v=20260608-quality-v40`);
    ...
    const compressedAppScript = await rawHttpGet('/app.js?v=20260608-quality-v40', { 'Accept-Encoding': 'gzip' });
