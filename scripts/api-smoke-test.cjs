...
async function run() {
  ...
  try {
    ...
    assert(serviceWorkerText.includes('atherix-static-v71-quality'), 'service worker should use the latest quality cache version');
    ...
    assert(serviceWorkerText.includes('/style.css?v=20260608-quality-v12') && serviceWorkerText.includes('/app.js?v=20260608-quality-v28'), 'service worker should precache the latest versioned app assets');
    ...
    assert(indexText.includes('href="/style.css?v=20260608-quality-v12"') && indexText.includes('src="/app.js?v=20260608-quality-v28"'), 'index should reference the latest versioned app assets');
    assert(indexText.includes('rel="preload" href="/style.css?v=20260608-quality-v12" as="style"') && indexText.includes('rel="preload" href="/app.js?v=20260608-quality-v28" as="script"') && indexText.includes('rel="preload" href="/lucide.min.js" as="script"'), 'index should preload critical local app assets');
    ...
    const styleSheet = await fetch(`${baseUrl}/style.css?v=20260608-quality-v12`);
    ...
    const appScript = await fetch(`${baseUrl}/app.js?v=20260608-quality-v28`);
    ...
    const compressedStyleSheet = await rawHttpGet('/style.css?v=20260608-quality-v12', { 'Accept-Encoding': 'gzip' });
    ...
    const compressedAppScript = await rawHttpGet('/app.js?v=20260608-quality-v28', { 'Accept-Encoding': 'gzip' });
