...
async function run() {
  ...
  try {
    ...
    assert(serviceWorkerText.includes('atherix-static-v27-mobile-controls'), 'service worker should use the latest mobile-controls cache version');
    ...
    assert(serviceWorkerText.includes('/style.css?v=20260608-mobile-controls-v6') && serviceWorkerText.includes('/app.js?v=20260608-mobile-controls-v6'), 'service worker should precache the latest versioned app assets');
    ...
    assert(indexText.includes('href="/style.css?v=20260608-mobile-controls-v6"') && indexText.includes('src="/app.js?v=20260608-mobile-controls-v6"'), 'index should reference the latest versioned app assets');
    assert(indexText.includes('rel="preload" href="/style.css?v=20260608-mobile-controls-v6" as="style"') && indexText.includes('rel="preload" href="/app.js?v=20260608-mobile-controls-v6" as="script"') && indexText.includes('rel="preload" href="/lucide.min.js" as="script"'), 'index should preload critical local app assets');
