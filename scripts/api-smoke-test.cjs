...
async function run() {
  ...
  try {
    ...
    assert(serviceWorkerText.includes('atherix-static-v35-boss-shield'), 'service worker should use the latest boss shield cache version');
    ...
    assert(serviceWorkerText.includes('/style.css?v=20260608-boss-shield-v1') && serviceWorkerText.includes('/app.js?v=20260608-boss-shield-v1'), 'service worker should precache the latest versioned app assets');
    ...
    assert(indexText.includes('href="/style.css?v=20260608-boss-shield-v1"') && indexText.includes('src="/app.js?v=20260608-boss-shield-v1"'), 'index should reference the latest versioned app assets');
    assert(indexText.includes('rel="preload" href="/style.css?v=20260608-boss-shield-v1" as="style"') && indexText.includes('rel="preload" href="/app.js?v=20260608-boss-shield-v1" as="script"') && indexText.includes('rel="preload" href="/lucide.min.js" as="script"'), 'index should preload critical local app assets');
