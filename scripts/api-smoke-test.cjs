...
async function run() {
  ...
  try {
    ...
    assert(serviceWorkerText.includes('atherix-static-v87-quality'), 'service worker should use the latest quality cache version');
    ...
    assert(serviceWorkerText.includes('/style.css?v=20260609-quality-v16') && serviceWorkerText.includes('/app.js?v=20260609-quality-v44'), 'service worker should precache the latest versioned app assets');
    ...
    assert(indexText.includes('href="/style.css?v=20260609-quality-v16"') && indexText.includes('src="/app.js?v=20260609-quality-v44"'), 'index should reference the latest versioned app assets');
    assert(indexText.includes('rel="preload" href="/style.css?v=20260609-quality-v16" as="style"') && indexText.includes('rel="preload" href="/app.js?v=20260609-quality-v44" as="script"') && indexText.includes('rel="preload" href="/lucide.min.js" as="script"'), 'index should preload critical local app assets');
    ...
    const styleSheet = await fetch(`${baseUrl}/style.css?v=20260609-quality-v16`);
    ...
    const appScript = await fetch(`${baseUrl}/app.js?v=20260609-quality-v44`);
    ...
    const compressedStyleSheet = await rawHttpGet('/style.css?v=20260609-quality-v16', { 'Accept-Encoding': 'gzip' });
    ...
    const compressedAppScript = await rawHttpGet('/app.js?v=20260609-quality-v44', { 'Accept-Encoding': 'gzip' });
